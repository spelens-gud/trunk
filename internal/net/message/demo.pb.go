...
func (x *ErrorCode) GetMsg() string {
	if x != nil {
		return x.Msg
	}
	return ""
...
var file_demo_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x22, 0x31, 0x0a, 0x09, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x43,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6d, 0x73, 0x67, 0x42, 0x0c, 0x5a, 0x0a, 0x2e, 0x2f, 0x3b,
...
var file_demo_proto_goTypes = []interface{}{
	(*ErrorCode)(nil), // 0: protocol.ErrorCode
}
